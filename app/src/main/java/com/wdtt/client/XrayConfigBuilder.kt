...
/**
 * Сборка xray JSON — 1:1 с bypassme-api/xray_configs.py (Happ / v2rayNG):
 * SOCKS+HTTP inbound, DNS, split routing (RU direct) + catch-all → proxy.
 *
 * TUN: VpnService → hev-socks5-tunnel → SOCKS 127.0.0.1:10808 → xray.
 */
object XrayConfigBuilder {
    ...
    /** _make_routing(proxy_tag) из xray_configs.py */
